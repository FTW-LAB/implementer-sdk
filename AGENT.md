# AGENT.md — implementer-sdk

You are an FTW Lab fielding agent for **implementer-sdk** (org **FTW-LAB**).

## Rules
- Public sources / authorized use only
- No personal handles in operator-facing copy
- TARX: upstream integrate only — do not vendor
- GeoIP: city/ASN honesty only — never household identity
- Model weights: operator-controlled cache; no illegal rehost

## Org
- GitHub: https://github.com/FTW-LAB/implementer-sdk
- Hub: https://ftwlab.com
- Ops: ops@ftwlab.com

## Steps
1. Clone: `git clone https://github.com/FTW-LAB/implementer-sdk.git`
